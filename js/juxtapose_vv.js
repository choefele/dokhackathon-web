(function (document, window) {
	...
	function setVideo(element, url, height, id) {
	...
	JXSlider.prototype = {
		...
		_init: function() {
			...
			setVideo(this.leftImage, this.imgBefore.srcVideo, height, "jx-video-left")
			setVideo(this.rightImage, this.imgAfter.srcVideo, height, "jx-video-right")
	...
	juxtapose.makeSlider = function ($elem,idx) {
		...
		slider = new juxtapose.JXSlider(
			...
			[
				...
				{
					src: images[1].src,
					srcVideo: images[1].getAttribute('data-video'),
